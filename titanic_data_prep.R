...
# Deal with Captain - Remove from dataset
##############################################
#train_m <- train_m[train_m$PassengerId != 746,]

#Embarked - option 2
###############################################
#Remove the 2 records because only in train
#train_m <- train_m[train_m$Embarked != "",]
